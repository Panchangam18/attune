 ...
 */
export function patch(resourcesPath: string, appId: string, preloadSourcePath: string): void {
  ...
  writeFileSync(
    join(asarPath, 'package.json'),
    JSON.stringify({ name: 'attune-shim', main: 'index.js' }, null, 2)
  );
 ...
 */
export function unpatch(resourcesPath: string): void {
 ...
 */
function generateShim(preloadPath: string, configPath: string, appId: string): string {
